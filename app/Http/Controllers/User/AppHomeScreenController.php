...
//        ];
        ...
        $sales_cate=Category::where('slug','sales')->first();
        $sales_child_category=ChildCategory::with('category','subcategory')->where('category_id',$sales_cate->id)->inRandomOrder()
            ->take(8)->get();
        $sales_child_category = ChildCategoryResource::collection($sales_child_category);
...
//            'random_sub_category_with_products'=>$random_sub_category_with_products,
            ...
            'sales_child_category'=>$sales_child_category,
        ]);
